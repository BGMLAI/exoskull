...
1. Otwórz: https://supabase.com/dashboard/project/ocixoxjozzldqldadrip/sql/new
...
```bash
psql "postgresql://postgres.ocixoxjozzldqldadrip:[PASSWORD]@db.ocixoxjozzldqldadrip.supabase.co:5432/postgres" -f supabase/migrations/20260131000001_init_exoskull_schema.sql
```
