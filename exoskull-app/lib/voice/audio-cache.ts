...
export const CACHED_PHRASES: CachedPhrase[] = [
  // Greetings (time-based)
  {
    ...
    text: "Dzień dobry! Jak się czujesz?",
    category: "greeting",
  },
  {
  ...
  },
  {
    ...
    text: "Hej! Jak minął dzień?",
    category: "greeting",
  },
  {
    key: "greeting_night",
    text: "Hej, jeszcze nie śpisz?",
    category: "greeting",
  },
  ...
  // Task responses
  {
    ...
    text: "Dodane.",
    category: "task",
    variants: ["Zapisane.", "Mam.", "Ok, dodałem."],
  },
  {
    key: "task_completed",
    text: "Oznaczone jako zrobione.",
    category: "task",
    variants: ["Super, odhaczyłem.", "Zrobione."],
  },
  {
    key: "no_tasks",
    text: "Nie masz żadnych zadań na liście.",
    category: "task",
    variants: ["Lista pusta.", "Brak zadań."],
  },
  ...
  },
  {
    ...
    text: "Mam problem z połączeniem. Chwila.",
    category: "error",
  },
];
...
CACHED_PHRASES.forEach((phrase) => {
  ...
  phrase.variants?.forEach((v) =>
    variantToKeyMap.set(v.toLowerCase(), phrase.key),
  );
});
...
export class AudioCache {
  ...
  async getCachedAudioUrl(key: string): Promise<string | null> {
    ...
    try {
      ...
      logger.warn(`Audio cache miss for key: ${key}`, error);
    }
...
export async function matchResponseToCache(
  responseText: string,
