...
export async function speechToText(
  ...
  try {
    ...
    console.log('[ElevenLabs STT] Transcribed:', {
...
export async function speechToTextFromUrl(
  ...
  try {
    ...
    console.log('[ElevenLabs STT] Downloaded audio:', {
...
export async function speechToTextDeepgram(
  ...
  try {
    ...
    console.log('[Deepgram STT] Transcribed:', {
...
export async function transcribeAudio(
  ...
  try {
    ...
    console.warn('[STT] ElevenLabs failed, trying Deepgram fallback:', elevenLabsError)
