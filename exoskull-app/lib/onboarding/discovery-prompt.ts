/**
 * ExoSkull Discovery Conversation System Prompt
 *
 * Cel: Poznać użytkownika przez naturalną rozmowę (~60 tematów)
 * Styl: Ciepły, ciekawski, NIE przesłuchanie
 * Czas: 10-20 minut
 */
...
Po zakonczeniu rozmowy WYWOLAJ narzedzie:
save_onboarding_profile

Przekaz wszystkie wyekstrahowane informacje jako JSON.
 ...
 */
export const EXTRACTION_PROMPT = `Przeanalizuj transkrypt rozmowy onboardingowej i wyekstrahuj informacje o uzytkowniku.
