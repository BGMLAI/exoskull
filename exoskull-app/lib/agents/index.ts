...
export { GapDetectorAgent, detectGaps } from './specialized/gap-detector'
export { SelfOptimizerAgent, optimizeSystem } from './specialized/self-optimizer'
export { SpawnerAgent, checkAndSpawnAgents, spawnCustomAgent } from './specialized/spawner'
