...
export const MODEL_CONFIGS: Record<ModelId, ModelConfig> = {
  ...
  'kimi-k2.5': {
    ...
    inputCostPer1M: 0.50,     // Placeholder pricing
  ...
  'claude-opus-4-5': {
    ...
    inputCostPer1M: 15.00,    // $15 per 1M input tokens
    outputCostPer1M: 75.00,   // $75 per 1M output tokens
    maxTokens: 32000,
    supportsTools: true,
    supportsStreaming: true
  }
...
export const CLASSIFICATION_KEYWORDS = {
  tier1: [
    'wybierz', 'classify', 'categorize', 'route', 'yes/no', 'tak/nie',
    'extract', 'parse', 'greeting', 'pozdrow', 'hello', 'hi', 'cześć'
  ],
  tier4_crisis: [
    'samobójcz', 'suicide', 'kryzys', 'crisis', 'przemoc', 'violence',
    'panic', 'panika', 'emergency', 'nagły', 'help me', 'pomóż'
  ],
  tier4_meta: [
    'strategia', 'strategy', 'plan długoterminowy', 'long-term',
    'architecture', 'architektura', 'system design'
  ]
}
