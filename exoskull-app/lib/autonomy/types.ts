...
export interface PermissionCheckResult {
  granted: boolean
  reason: 'granted' | 'no_matching_grant' | 'disabled' | 'expired' | 'daily_limit_reached' | 'spending_limit_reached'
  grant?: AutonomyGrant
...
export interface AnalyzeResult {
  // Detected issues
  issues: Array<{
    type: 'sleep_debt' | 'task_overload' | 'missed_goal' | 'health_concern' | 'social_isolation' | 'productivity_drop' | 'custom'
...
export const LIFE_AREAS: LifeArea[] = [
  {
    ...
    dataPoints: ['sleep_entries', 'activity_entries', 'health_checkins', 'meal_logs'],
  },
  {
    slug: 'productivity',
