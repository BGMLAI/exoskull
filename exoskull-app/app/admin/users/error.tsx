...
export default function UsersError({
  ...
  useEffect(() => {
    console.error("[Admin][UsersError]", error);
  }, [error]);

  return (
    <div className="flex items-center justify-center h-full min-h-[50vh] p-6">
      <div className="max-w-md text-center space-y-4">
        <h2 className="text-xl font-semibold">Blad ladowania uzytkownikow</h2>
        <p className="text-muted-foreground text-sm">
          Nie udalo sie zaladowac danych uzytkownikow. Sprobuj ponownie.
        </p>
        {error.digest && (
