...
export default function InsightsError({
  ...
  useEffect(() => {
    console.error("[Admin][InsightsError]", error);
  }, [error]);

  return (
    <div className="flex items-center justify-center h-full min-h-[50vh] p-6">
      <div className="max-w-md text-center space-y-4">
        <h2 className="text-xl font-semibold">Blad ladowania insightow</h2>
        <p className="text-muted-foreground text-sm">
          Nie udalo sie zaladowac insightow. Sprobuj ponownie.
        </p>
        {error.digest && (
