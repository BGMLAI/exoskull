...
export function ModelPicker({ isOpen, onClose, onSelect }: ModelPickerProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="w-full max-w-2xl max-h-[80vh] bg-[#0a0a1a] border border-cyan-900/30 rounded-xl shadow-2xl shadow-cyan-900/10 overflow-hidden flex flex-col">
        {/* Header */}
        ...
        {/* Tabs */}
        <div className="flex gap-1 px-5 py-3 bg-black/30">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            return (
              <button
            ...
            <>
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-black/30 border border-cyan-900/20 rounded-lg text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-cyan-700/40"
                  autoFocus
                />
              </div>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedModel?.uid === model.uid
                          ...
                          : "border-cyan-900/20 hover:border-cyan-800/30",
                      )}
                    >
                      <img
                        src={model.thumbnailUrl}
                        alt={model.name}
                        className="w-full h-28 object-cover bg-[#0f0f1f]"
                        loading="lazy"
                      />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-black/30 border border-cyan-900/20 rounded-lg text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-cyan-700/40"
                />
              </div>
              <button
        ...
        {activeTab === "sketchfab" && selectedModel && (
          <div className="px-5 py-3 border-t border-cyan-900/20 flex items-center justify-between bg-black/30">
            ...
            <div className="flex gap-2">
              <a
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-[11px] text-slate-400 hover:text-white transition-colors"
              >
